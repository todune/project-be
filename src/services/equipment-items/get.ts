...
export const getEquipmentItems = async (req: Request, res: Response) => {
     ...
     const queryOptions = {
          ...
          include: [{ model: Category, as: 'catEquipmentData' }],
     }

     const pagination = new PaginationRes(EquipmentItem, queryOptions, { page, limit })
